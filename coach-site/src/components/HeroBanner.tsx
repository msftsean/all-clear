    ...
    return (
      ...
      >
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse 60% 120% at 50% 0%, rgba(0,129,192,0.16) 0%, transparent 70%)',
          }}
        />
        <div className="relative max-w-5xl mx-auto px-6 py-3 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 min-w-0">
            <span className="w-2 h-2 rounded-full bg-cofounder flex-shrink-0" aria-hidden="true" />
          ...
          >
            <ChevronDownRegular style={{ width: 16, height: 16 }} aria-hidden="true" />
            Expand intro
          </button>
        </div>
      </div>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 80% 60% at 50% 100%, rgba(0,129,192,0.18) 0%, transparent 70%), ' +
            'radial-gradient(ellipse 60% 40% at 20% 80%, rgba(0,60,120,0.15) 0%, transparent 60%)',
        }}
      />
      ...
      <div
        ...
        style={{
          height: '80px',
          background: 'linear-gradient(to top, rgba(0,129,192,0.12), transparent)',
        }}
      />
      ...
      <div className="relative max-w-5xl mx-auto px-6 pt-4 flex justify-end">
        ...
        >
          <ChevronUpRegular style={{ width: 16, height: 16 }} aria-hidden="true" />
          Collapse intro
        </button>
      </div>
      ...
      <div className="relative max-w-5xl mx-auto px-6 pb-16 pt-4 sm:pb-24">
        <div
          style={
            !prefersReduced.current
              ? { animation: 'fade-slide-up 0.9s ease-out forwards', opacity: 0 }
              : {}
          }
        >
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-white/20 bg-white/8 mb-6">
            <span className="w-2 h-2 rounded-full bg-cofounder animate-pulse" aria-hidden="true" />
          ...
          <p
            ...
            style={
              !prefersReduced.current
                ? { animation: 'fade-slide-up 0.9s 0.2s ease-out forwards', opacity: 0 }
                : {}
            }
          >
            How to prepare for and help participants during the 47 Doors AJCU hackathon.
          </p>
          ...
          <button
            ...
            style={
              !prefersReduced.current
                ? { animation: 'fade-slide-up 0.9s 0.4s ease-out forwards', opacity: 0 }
                : {}
            }
          >
            Start with Prepare →
