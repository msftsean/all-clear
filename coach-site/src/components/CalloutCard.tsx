...
const iconPaths: Record<Tone, string> = {
  ...
  success:
    "M10 2a8 8 0 1 0 0 16 8 8 0 0 0 0-16Zm3.65 6.35-4.5 4.5a.5.5 0 0 1-.72-.02l-2-2.25a.5.5 0 1 1 .74-.66l1.65 1.86 4.12-4.13a.5.5 0 0 1 .71.7Z",
};
  ...
  return (
    <div className={`callout ${styles.bg}`}>
      <div className="flex gap-3">
        <span
          className="mt-0.5 flex-shrink-0 inline-flex h-7 w-7 items-center justify-center rounded-full bg-surface/75 border border-border"
          aria-hidden="true"
        >
          <svg
        ...
        <div>
          {title && (
            <h3 className={`font-semibold mb-1.5 text-sm ${styles.title}`}>
              {title}
            </h3>
          )}
