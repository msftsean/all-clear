      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 my-12">
          ...
          <div className="card bg-brand/5">
            ...
            <div className="flex flex-col items-center justify-center h-full">
              ...
              <p className="text-sm text-ink/70 text-center mt-2">
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-12">
          <div className="card text-center">
            <div className="text-3xl font-bold text-brand mb-2">3.2</div>
          ...
          <div className="card text-center">
            <div className="text-3xl font-bold text-brand mb-2">67%</div>
            <p className="text-sm text-ink/70">
          ...
          <div className="card text-center">
            <div className="text-3xl font-bold text-brand mb-2">30-50+</div>
            <p className="text-sm text-ink/70">
