  ...
  return (
    <div role="tabpanel" id="reuse-panel" aria-labelledby="reuse-tab">
      <div className="max-w-4xl mx-auto">
        ...
        >
          {/* Central hub */}
          <circle cx="300" cy="250" r="70" fill="#0F6CBD" stroke="#1B1B1F" strokeWidth="3" />
            ...
            return (
              <g key={i}>
                <line 
                  ...
                  strokeDasharray="5,5"
                />
                <circle cx={x} cy={y} r="45" fill="#F7F8FA" stroke="#1B1B1F" strokeWidth="2" />
                <text 
                  x={x} 
                  y={y + 4} 
                  textAnchor="middle" 
        ...
        <div className="grid md:grid-cols-2 gap-8 my-12">
          ...
          <div className="card border-iu-crimson/30 bg-iu-crimson/5">
            <h3 className="font-semibold text-lg mb-4 text-dark-text">
              What Stays the Same
            </h3>
            <ul className="space-y-3 text-ink/75">
        ...
        <div className="card mb-8">
          ...
          <ul className="text-sm text-ink/70 space-y-1 ml-4">
            <li>• Azure OpenAI resource with GPT-4.1 + GPT Realtime deployments</li>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mt-8 border-2 border-brand">
