    ...
    <div role="tabpanel" id="your-first-agent-panel" aria-labelledby="your-first-agent-tab">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8 mb-12">
          ...
          <div className="card">
            ...
            <input
              ...
              className="w-full px-4 py-3 border-2 border-border rounded-lg focus:border-brand focus:outline-none text-lg"
          ...
          <div className="card">
            ...
            <input
              ...
              className="w-full px-4 py-3 border-2 border-border rounded-lg focus:border-brand focus:outline-none text-lg mb-3"
            ...
            <div className="flex flex-wrap gap-2">
              {exampleOwns.map((example, i) => (
                <button
                  ...
                  className="px-3 py-1 bg-surface-muted hover:bg-brand hover:text-white rounded-full text-sm transition-colors"
                >
                  {example}
                </button>
              ))}
            ...
            <div className="flex flex-wrap gap-2">
              {exampleNever.map((example, i) => (
                <button
                  ...
                  className="px-3 py-1 bg-surface-muted hover:bg-iu-crimson hover:text-white rounded-full text-sm transition-colors"
                >
                  {example}
                </button>
              ))}
        ...
        {(agentName || agentOwns || agentNever) && (
          <div className="card border-2 border-brand bg-brand/5 mb-8">
            <h3 className="font-semibold text-lg mb-4 text-dark-text text-center">Your Agent Card</h3>
            <div className="bg-white rounded-lg p-6 font-mono text-sm border-2 border-border">
              ...
              <div className="border-t border-border mt-4 pt-4 space-y-1 text-xs text-ink/70">
        ...
        <div className="mt-8 p-6 bg-brand text-white rounded-lg">
          ...
          <div className="flex gap-4">
            <a 
              ...
              className="px-4 py-2 bg-white text-brand rounded-md font-medium hover:bg-surface-muted transition-colors text-sm"
              target="_blank"
