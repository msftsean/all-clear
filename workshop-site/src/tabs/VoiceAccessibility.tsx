  ...
  return (
    <div role="tabpanel" id="voice-panel" aria-labelledby="voice-tab">
      <div className="max-w-4xl mx-auto">
        ...
        >
          {/* Student speaks */}
          <circle cx="80" cy="80" r="35" fill="#0F6CBD" />
          ...
          {/* Arrow down */}
          <path d="M 80 120 L 80 155" stroke="#1B1B1F" strokeWidth="2" markerEnd="url(#arrowhead)" />

          {/* Browser mic */}
          <rect x="40" y="160" width="80" height="50" fill="#F7F8FA" stroke="#0F6CBD" strokeWidth="2" rx="6" />
          <text x="80" y="190" textAnchor="middle" fontSize="11" fill="#1B1B1F" fontWeight="bold">
            Browser mic
          </text>

          {/* Arrow to WebRTC */}
          <path d="M 125 185 L 185 185" stroke="#1B1B1F" strokeWidth="2" markerEnd="url(#arrowhead)" />
          <text x="155" y="178" textAnchor="middle" fontSize="9" fill="#666">WebRTC</text>

          {/* Azure OpenAI Realtime API */}
          <rect x="190" y="150" width="160" height="70" fill="#0F6CBD" stroke="#1B1B1F" strokeWidth="2" rx="8" />
          ...
          <path d="M 270 225 L 270 260" stroke="#1B1B1F" strokeWidth="2" markerEnd="url(#arrowhead)" />
          ...
          {/* 3-Agent Pipeline */}
          <rect x="180" y="265" width="180" height="60" fill="#F7F8FA" stroke="#990000" strokeWidth="3" rx="8" />
          <text x="270" y="290" textAnchor="middle" fontSize="13" fill="#1B1B1F" fontWeight="bold">
            3-Agent Pipeline
          </text>
          ...
          {/* Arrow back up */}
          <path d="M 365 295 L 430 240" stroke="#1B1B1F" strokeWidth="2" markerEnd="url(#arrowhead)" />

          {/* AI speaks response */}
          <rect x="380" y="150" width="150" height="70" fill="#0F6CBD" stroke="#1B1B1F" strokeWidth="2" rx="8" />
        ...
        <div className="grid md:grid-cols-2 gap-6 my-12">
          <div className="card">
            <div className="flex items-center gap-3 mb-4">
              <MicrophoneIcon className="w-6 h-6 text-brand" />
          ...
          <div className="card">
            <div className="flex items-center gap-3 mb-4">
              <SpeakerWaveIcon className="w-6 h-6 text-brand" />
          ...
          <div className="card">
            <div className="flex items-center gap-3 mb-4">
              <CircleStackIcon className="w-6 h-6 text-brand" />
