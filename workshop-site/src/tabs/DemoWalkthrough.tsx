    ...
    <div role="tabpanel" id="demo-panel" aria-labelledby="demo-tab">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8 mb-12">
          {steps.map((step) => (
            <div key={step.number} className="card border-brand/20 bg-brand/5">
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-12 h-12 rounded-full bg-brand text-white flex items-center justify-center font-bold text-xl">
                  {step.number}
                </div>
                <div className="flex-1">
                  <h3 className="font-semibold text-xl text-dark-text mb-2">{step.title}</h3>
                  <div className="bg-surface-muted rounded p-3 mb-3 font-mono text-sm text-dark-text">
                    {step.example}
                  </div>
                  <div className="flex items-center gap-3 mb-2">
                    <span className="text-3xl">{step.visual}</span>
                    <span className="text-sm text-ink/70">{step.visualLabel}</span>
                  </div>
                  <div className="text-sm text-ink/80 bg-brand/5 rounded-lg p-3 border border-brand/20">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="card bg-red-50 border-red-200">
            ...
            <p className="text-ink/75 mb-2 italic">
        ...
        <div className="card mt-8">
          ...
          <div className="space-y-4">
            <div className="bg-surface-muted rounded-lg p-4">
              <div className="font-mono text-sm text-ink/80 mb-2">
                <strong>Student:</strong> "Can you delete my parking tickets?"
              </div>
              <div className="font-mono text-sm text-brand bg-brand/5 p-3 rounded-lg border border-brand/20">
            ...
            <div className="bg-surface-muted rounded-lg p-3">
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm italic text-ink/75">"I forgot my password and can't log into Canvas"</p>
                  <p className="text-xs text-ink/60 mt-1">→ TECHNICAL_SUPPORT → IT → ticket + KB articles + SLA</p>
                </div>
              </div>
            </div>
            <div className="bg-surface-muted rounded-lg p-3">
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm italic text-ink/75">"My financial aid was supposed to be disbursed last week but my account still shows a balance"</p>
                  <p className="text-xs text-ink/60 mt-1">→ BILLING → FINANCIAL_AID → ticket + disbursement KB</p>
                </div>
              </div>
            </div>
            <div className="bg-red-50 rounded-lg p-3 border border-red-200">
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm italic text-ink/75">"I want to appeal my grade"</p>
                  <p className="text-xs text-ink/60 mt-1">→ POLICY_EXCEPTION → ESCALATE_TO_HUMAN → human advisor</p>
                </div>
              </div>
            </div>
            <div className="bg-red-50 rounded-lg p-3 border border-red-200">
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm italic text-ink/75">"Can I speak to a real person?"</p>
                  <p className="text-xs text-ink/60 mt-1">→ HUMAN_REQUEST → ESCALATE_TO_HUMAN → escalation flow</p>
                </div>
              </div>
            </div>
            <div className="bg-amber-50 rounded-lg p-3 border border-amber-200">
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm italic text-ink/75">"This is urgent — I can't submit my assignment tonight and Canvas keeps crashing!"</p>
                  <p className="text-xs text-ink/60 mt-1">→ Sentiment: FRUSTRATED/URGENT → priority bumped to HIGH</p>
                </div>
              </div>
            </div>
            <div className="bg-surface-muted rounded-lg p-3">
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm italic text-ink/75">"Can you check the status of that ticket?"</p>
                  <p className="text-xs text-ink/60 mt-1">→ Works in voice or text — same session context</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="card mt-8 border-green-200 bg-green-50">
          <h3 className="font-semibold text-lg mb-4 text-dark-text flex items-center gap-2">
          ...
          <ol className="space-y-3 mb-6">
            <li className="flex items-start gap-3">
              ...
              <p className="text-ink/75">Open LivePage (<code className="bg-surface-muted px-1.5 py-0.5 rounded text-sm">/live</code>) on the projector</p>
            </li>
            <li className="flex items-start gap-3">
              ...
              <p className="text-ink/75">Call <strong>+1-913-217-1946</strong> from your phone</p>
            </li>
            <li className="flex items-start gap-3">
              ...
              <p className="text-ink/75">Follow the RunbookPage script (<code className="bg-surface-muted px-1.5 py-0.5 rounded text-sm">/runbook</code>) — presenter only</p>
            </li>
            <li className="flex items-start gap-3">
              ...
              <p className="text-ink/75">Audience watches real-time transcript on LivePage</p>
            </li>
          </ol>
