...
export default function NotFound() {
  return (
    <div className="max-w-5xl mx-auto px-4 py-20 text-center">
      ...
      <Link
        to="/"
        className="mt-8 inline-block rounded bg-maroon px-6 py-3 text-base font-medium text-cream hover:bg-deep-maroon focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold transition-colors"
      >
        Back to the doors
      </Link>
    </div>
