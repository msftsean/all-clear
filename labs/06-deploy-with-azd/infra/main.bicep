...
// Azure OpenAI
// ============================================================================
resource openAi 'Microsoft.CognitiveServices/accounts@2024-10-01-preview' = {
  name: '${prefix}-openai'
  location: location
  tags: tags
  kind: 'OpenAI'
...
resource openAiDeployment 'Microsoft.CognitiveServices/accounts/deployments@2024-10-01-preview' = {
  parent: openAi
  name: openAiModel
  properties: {
    model: {
...
// Azure AI Search
// ============================================================================
resource searchService 'Microsoft.Search/searchServices@2024-11-01' = {
  name: '${prefix}-search'
  location: location
  tags: tags
  sku: {
