...
- VFR-002: gpt-realtime model via WebRTC (browser RTCPeerConnection direct to Azure)
...
- VFR-023: Bicep includes gpt-realtime deployment
...
**Dependencies**:
- Azure OpenAI gpt-realtime (production required)
...
**Infrastructure**:
- infra/main.bicep - MODIFY (add gpt-realtime)
