...
|---|---|---|---|
| 🧠 GPT-4.1 | `2025-04-14` | Text chat pipeline | ✅ Active |
| 🎤 GPT Realtime Preview | `2024-10-01` | Voice / WebRTC | ✅ Active |
...
| 6️⃣ | 🤖 **Azure OpenAI connected** | `MOCK_MODE=false` · live `gpt-4.1` + `gpt-realtime` deployments on `frontdoor-6wfum6gndxawy-openai` | ☐ |
...
> *"What you just saw is running live on Azure — connected to Azure OpenAI GPT Realtime API in East US 2. Here's what the path forward looks like."*
