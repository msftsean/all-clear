...
### What's Being Built
- **Feature**: Real-time voice conversations using Azure OpenAI GPT Realtime API
...
1. **Model Layer**: System prompt instructs GPT-4.1 not to repeat PII
...
- [ ] T005: Add gpt-realtime to infra/main.bicep
...
### Infrastructure
- infra/main.bicep - Add gpt-realtime deployment
