...
- Changed default model from `gpt-4` to `gpt-4.1` in `retrieve_agent.py`
...
| DeploymentNotFound for gpt-4 | 04, 05 | Changed default model to gpt-4.1 |
...
| - gpt-4.1 | Chat completions | Default capacity |
