...
| Service                  |             SKU             | Monthly Cost | % of Total |
| ------------------------ | :-------------------------: | -----------: | ---------: |
| 🤖 Azure OpenAI (GPT-4.1) |          Standard           |      $50-150 |        40% |
...
| Service                  |            SKU            | Monthly Cost | % of Total |
| ------------------------ | :-----------------------: | -----------: | ---------: |
| 🤖 Azure OpenAI (GPT-4.1) |         Standard          |     $150-350 |        45% |
...
| Service                  |             SKU             |     Monthly Cost | % of Total |
| ------------------------ | :-------------------------: | ---------------: | ---------: |
| 🤖 Azure OpenAI (GPT-4.1) |          Standard           |       $500-1,000 |        45% |
...
GPT-4.1 is the primary cost driver. Understanding token usage is key to cost optimization.

### 💵 Token Pricing (as of 2024)

| Model          | Input (per 1M tokens) | Output (per 1M tokens) | Best For               |
| -------------- | --------------------: | ---------------------: | ---------------------- |
| 🤖 GPT-4.1      |                 $5.00 |                 $15.00 | Complex classification |
...
### 📊 Monthly Volume Estimates (GPT-4.1)
...
| Metric             | GPT-4.1  | GPT-4o-mini | Savings |
| ------------------ | :-----: | :---------: | ------: |
...
- 🤖 GPT-4.1: Complex/ambiguous cases, response generation
...
async def classify_intent(message: str) -> QueryResult:
    ...
    # 🤔 If confidence is low, escalate to GPT-4.1
...
1. 🤖 Azure OpenAI (GPT-4.1, your expected token volume)
