...
### Decision
Azure OpenAI GPT-4.1 for intent classification and entity extraction.

### Rationale
- Azure OpenAI is available in Azure AI Foundry with enterprise SLAs
- GPT-4.1 provides excellent few-shot classification performance for 30+ intent categories
...
|--------|------|------|------------------|
| Azure Claude (Anthropic) | Excellent reasoning | Limited availability in Azure AI Foundry as of Jan 2026 | Deployment complexity; GPT-4.1 sufficient |
