...
// AJCU Jesuit taxonomy reskin: department/intent legend labels mapped to the
// six scenario intents (Financial Aid, Registrar, Campus Ministry, IT,
// Student Wellness, General/Mission). Routing enum keys are unchanged.
const DEPARTMENT_LABELS: Record<Department, string> = {
  IT: 'IT',
  HR: 'General / Mission',
  REGISTRAR: 'Registrar',
  FINANCIAL_AID: 'Financial Aid',
  FACILITIES: 'General / Mission',
  STUDENT_AFFAIRS: 'Student Wellness',
  CAMPUS_SAFETY: 'Campus Ministry',
  ESCALATE_TO_HUMAN: 'General / Mission',
};

// Legend filter: the six AJCU intents (one representative routing key each).
